      ...
      <div className="flex gap-2 sm:gap-3">
        <div className="flex-1 relative group">
          <input
            ...
            className={`relative w-full h-12 bg-background-secondary dark:bg-surface-elevated border-[1.5px] border-transparent rounded-2xl pl-11 sm:pl-12 pr-4 text-sm text-text-primary placeholder:text-text-muted focus:outline-none transition-[border-color,box-shadow] duration-200 focus:border-primary dark:focus:border-primary ${NEUMORPHIC_INSET.base} ${NEUMORPHIC_INSET.focus}`}
          />
          <svg
            className="absolute left-3.5 sm:left-4 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-text-muted group-focus-within:text-primary transition-colors duration-200"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
