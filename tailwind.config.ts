  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'elevation-2': '0 2px 8px -2px rgb(0 0 0 / 0.5), 0 1px 2px -1px rgb(0 0 0 / 0.3)',
        'elevation-3': '0 8px 24px -4px rgb(0 0 0 / 0.5), 0 2px 8px -2px rgb(0 0 0 / 0.3)',
        'elevation-4': '0 16px 48px -8px rgb(0 0 0 / 0.6), 0 4px 12px -2px rgb(0 0 0 / 0.4)',
